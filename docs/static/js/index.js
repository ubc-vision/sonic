...
var INTERP_BASE = "./static/noise_optimization";
var NUM_INTERP_FRAMES = 19;

var interp_images = [];
function preloadInterpolationImages() {
  for (var i = 0; i < NUM_INTERP_FRAMES; i++) {
    var path = INTERP_BASE + "/" + i + ".jpg";
...
function resetAutoScrollTimer() {
  ...
  autoScrollTimer = setInterval(autoScrollSlider, 200); // Set new timer
}
